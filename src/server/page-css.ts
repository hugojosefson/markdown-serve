...
.markdown-body .symbol-declaration { display: inline-block; scroll-margin-block-start: calc(var(--attached-comment-lines, 0) * 1lh); }.source-line:has(.symbol-declaration:target), .markdown-body .symbol-declaration:target { background: var(--code-hover); }.markdown-body .symbol-declaration:target { outline: 2px solid var(--focus-color); outline-offset: 1px; }
